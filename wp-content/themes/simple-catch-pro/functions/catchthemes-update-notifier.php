...
/**
 * Catch Themes Updater Checker
 *
 * Checks for updates and implements it if download url is given
 *
...
$catchthemes_update_checker = new catchthemes_update_checker(
   'simple-catch-pro',
   'http://catchthemes.com/update-notifier/simple-catch-pro/theme_meta_data.json'
);